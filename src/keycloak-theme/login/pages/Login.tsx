...
export default function Login(
  ...
  const [isOpenGoogleAuthenticator, setIsOpenGoogleAuthenticator] =
  ...
  const [
    isOpenGoogleAuthenticatorSuccess,
    setIsOpenGoogleAuthenticatorSuccess,
  ] = useState<boolean>(false);
  ...
  return (
    ...
    >
      <ModalComponent
        title={
          <Row justify={"center"}>
            <span style={{ color: "#4284f5" }}>
              {msgStr("googleAuthentication")}
            </span>
          </Row>
        }
        i18n={i18n}
      ...
      >
        <WrapGoogleAuthencatorSuccess>
          <Space className="text-content">
            ...
            <span className="active-success">
              {msgStr("successfullyActived")}
            </span>
          </Space>
                          ...
                          rules={[
                            {
                              ...
                              validator: (_: any, value: any) => {
                                return (![undefined, null].includes(value)
                                  ...
                                  ? Promise.resolve()
                                  : Promise.reject(
                                      new Error(msgStr("requiredField"))
                                    );
                              },
                            },
          ...
          <WrapGoogleAuthencator>
            ...
            <Space>
              ...
              <Button
                type="primary"
                onClick={() =>
                  loginRequest && onSubmit(loginRequest, true, "active")
                }
              >
